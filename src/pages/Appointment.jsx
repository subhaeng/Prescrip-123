  ...
  return docInfo && (
    <div>
            ...
            <div  className='flex flex-col sm:flex-row gap-4'>
              ...
              <div className='flex-1 border broder-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px]sm:mt-0'>
                {/*---Doctors Info*/ }
               <p className='flex items-center gap-2 text-2xl font-medium text-gray-900'>{docInfo.name} <img src={assets.verified_icon} alt="" /></p>
              <div className='flex items-center gap-2 text-xs rounded-full'>
           ...
           <p className='text-gray-500 font-medium mt-4'>
            ...
            {/* ---Booking SLOTS---*/ }
            <div className='sm:m-72 sm:pl-4 mt-4 font-medium text-gray-700'>
                 <p>Booking Slots</p>
